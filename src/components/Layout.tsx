  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        {/* Subtle leaf texture pattern */}
        <div className="absolute inset-0 opacity-[0.03]" 
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='80' height='80' viewBox='0 0 80 80' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%2322543d'%3E%3Cpath d='M40 10 Q50 25 40 40 Q30 25 40 10 Z'/%3E%3Cpath d='M20 50 Q30 65 20 80 Q10 65 20 50 Z' opacity='0.5'/%3E%3Cpath d='M60 50 Q70 65 60 80 Q50 65 60 50 Z' opacity='0.5'/%3E%3C/g%3E%3C/svg%3E")`,
          }}
        />
      </div>
